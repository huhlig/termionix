...
use crate::{CSICommand, ControlCode, Style};
...
impl AnsiMapper {
    ...
    fn parse_csi(&self) -> CSICommand {
        // Parse CSI command from self.bytes
        // This is a simplified parser that returns Unknown
        // A full implementation would parse the command properly
        CSICommand::Unknown
    }
}
