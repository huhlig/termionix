...
pub mod option {
    ...
    pub mod linemode {
        ...
        pub mod mode {
            pub const EDIT: u8 = 2;
            pub const TRAPSIG: u8 = 2;
            pub const MODE_ACK: u8 = 2;
            pub const SOFT_TAB: u8 = 2;
            pub const LIT_ECHO: u8 = 2;
        }
    ...
    pub mod status {
        /// Status Subnegotiation IS command.
        pub const IS: u8 = 0;
        /// Status Subnegotiation SEND command.
        pub const SEND: u8 = 1;
    }

    ///
    /// Telnet Options supported by this library.
    /// Set to True when the implementation exists.
